...
(function() {
    ...
    function pgCreateSVG(dummytag, dummyprops, svg) {
        const pgReact = new PgHTMLToReact3();
        const el = window.wp.element.createElement;
    ...
    window.pgCreateSVG3 = pgCreateSVG;
})()

function PgGetServerSideRender3() {
    ...
    return function (props) {
        ...
        try {
            ...
            if (isMountedRef.currentCode !== response) {
                isMountedRef.currentFunction = new PgHTMLToReact3();
...
window.PgServerSideRender3 = PgGetServerSideRender3();
